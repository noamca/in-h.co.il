...
<div class="gallery-container">
	...
	<div class="swiper-container gallery-slider">
		<div class="swiper-wrapper">
			...
			<div class="cursor swiper-slide disable-modal slides_<?php echo $slidesPerView ?>" data-toggle="modal" data-target="#galleryModal" onclick="openModal(<?php echo ($index) ?>)" style="background:url(<?php echo $image['sizes']['large']; ?>)"></div>
			<?php endforeach; ?>
		</div>
	</div>	
